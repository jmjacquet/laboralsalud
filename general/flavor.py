...
class ARPostalCodeField(EmptyValueCompatMixin, RegexField):
    ...
    default_error_messages = {
        'invalid': _("Debe ingresar un CP con formato NNNN o ANNNNAAA."),
    }
...
class ARDNIField(EmptyValueCompatMixin, CharField):
    ...
    default_error_messages = {
        'invalid': _("Deben cargarse solamente numeros."),
        'max_digits': _("Requiere 7/8 digitos."),
    }

    def __init__(self, max_length=15, min_length=7, *args, **kwargs):
...
class ARCUITField(EmptyValueCompatMixin, RegexField):
    ...
    default_error_messages = {
        ...
        'checksum': _("CUIT no valido."),
        'legal_type': _('Tipo CUIT no válido. Tipo debe ser 27, 20, 30, 23, 24, 33 o 34.'),
    }
...
class ARCBUField(EmptyValueCompatMixin, CharField):
    ...
    default_error_messages = {
        ...
        'max_length': _('CBU debe tener 22 digitos.'),
        'min_length': _('CBU debe tener 22 digitos.'),
        'checksum': _('CBU no valido.'),
    }
